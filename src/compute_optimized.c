...
int dot(uint32_t n, int32_t *vec1, int32_t *vec2) {
  // TODO: implement dot product of vec1 and vec2, both of size n
    ...
    for(uint32_t i = 0; i < n/64 * 64; i += 64) {
      ...
      dot += tmp_arr5[0] + tmp_arr5[1] + tmp_arr5[2] + tmp_arr5[3] + tmp_arr5[4] + tmp_arr5[5] + tmp_arr5[6] + tmp_arr5[7];
      ...
      dot += tmp_arr6[0] + tmp_arr6[1] + tmp_arr6[2] + tmp_arr6[3] + tmp_arr6[4] + tmp_arr6[5] + tmp_arr6[6] + tmp_arr6[7];
      ...
      dot += tmp_arr7[0] + tmp_arr7[1] + tmp_arr7[2] + tmp_arr7[3] + tmp_arr7[4] + tmp_arr7[5] + tmp_arr7[6] + tmp_arr7[7];
      ...
      dot += tmp_arr8[0] + tmp_arr8[1] + tmp_arr8[2] + tmp_arr8[3] + tmp_arr8[4] + tmp_arr8[5] + tmp_arr8[6] + tmp_arr8[7];
